...
st.set_page_config(
    page_title="Cardano Price Prediction",
    page_icon="https://cryptologos.cc/logos/cardano-ada-logo.png?v=032"
)
...
fig = px.line(new_pred_plot, x=new_pred_plot.index, y=[new_pred_plot['last_original_days_value'],
              ...
              labels={'value': 'Cardano price', 'index': 'Timestamp'})
